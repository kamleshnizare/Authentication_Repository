"""distutils.command.registration

Implements the Distutils 'registration' command (registration with the repository).
"""
...
class register(PyPIRCCommand):
    ...
    description = "registration the distribution with the Python package index"
    ...
    def finalize_options(self):
        ...
        check_options = {
            'strict': ('registration', self.strict),
            'restructuredtext': ('registration', 1),
        }
    ...
    def check_metadata(self):
        """Deprecated API."""
        warn(
            "distutils.command.registration.check_metadata is deprecated; "
    ...
    def send_metadata(self):  # noqa: C901
        ...
        choices:
         ...
         2. registration as a new user, or
