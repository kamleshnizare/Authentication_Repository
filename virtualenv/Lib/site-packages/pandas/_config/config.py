...
- a developer can registration and mark an option as deprecated.
- you can registration a callback to be invoked when the option value
...
def config_prefix(prefix: str) -> Generator[None, None, None]:
    ...
    supported API functions: (registration / get / set )__option
    ...
    will registration options "display.font.color", "display.font.size", set the
