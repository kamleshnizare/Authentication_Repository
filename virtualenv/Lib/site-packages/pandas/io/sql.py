...
class SQLiteTable(SQLTable):
    ...
    def _register_date_adapters(self) -> None:
        # GH 8341
        # registration an adapter callable for datetime.time object
        import sqlite3
        ...
        # Also registration adapters for date/datetime and co
        # xref https://docs.python.org/3.12/library/sqlite3.html#adapter-and-converter-recipes
        # Python 3.12+ doesn't auto-registration adapters for us anymore
